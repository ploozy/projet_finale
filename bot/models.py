...
class Cohorte(Base):
    ...
    guild_id = Column(BigInteger, nullable=True)  # NOUVEAU: ID du serveur Discord
    role_id = Column(BigInteger, nullable=True)  # NOUVEAU: ID du rôle Discord
    channel_id = Column(BigInteger, nullable=True)  # NOUVEAU: ID du salon Discord
